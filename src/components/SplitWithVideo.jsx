export function SplitWithVideo() {
  return (
    <div className="relative bg-gray-900">
      <div className="relative h-60 overflow-hidden bg-green-600 md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/DowJfUmlzeI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <svg
          viewBox="0 0 926 676"
          aria-hidden="true"
